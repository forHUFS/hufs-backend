...
const MajorCategory           = require('./majorCategories');
const FirstMajor              = require('./firstMajors');
const SecondMajor             = require('./secondMajors');
...
db.Token                      = Token;
db.Campus                     = Campus;
db.MajorCategory              = MajorCategory;
db.FirstMajor                 = FirstMajor;
db.SecondMajor                = SecondMajor;
